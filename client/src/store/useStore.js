...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Lightning Fast. Secure. Reliable.',
  ...
  es: {
    ...
    'hero.subtitle': 'Rápido. Seguro. Confiable.',
  ...
  fr: {
    ...
    'hero.subtitle': 'Rapide. Sécurisé. Fiable.',
  ...
  de: {
    ...
    // Hero
    'hero.title': 'Premium Cloud-Hosting',
    'hero.subtitle': 'Blitzschnell. Sicher. Zuverlässig.',
