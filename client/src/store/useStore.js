...
const translations = {
  en: {
    ...
    'nav.about': 'About Us',
    'nav.company': 'Company',
    'nav.securityTools': 'Security & Tools',
    'nav.login': 'Login',
  ...
  es: {
    ...
    'nav.about': 'Nosotros',
    'nav.company': 'Empresa',
    'nav.securityTools': 'Seguridad y Herramientas',
  ...
  fr: {
    ...
    'nav.securityTools': 'Sécurité & Outils',
    'nav.login': 'Connexion',
  ...
  de: {
    ...
    'nav.securityTools': 'Sicherheit & Tools',
    'nav.login': 'Anmelden',
  ...
  ar: {
    ...
    'nav.about': 'من نحن',
    'nav.company': 'الشركة',
    'nav.securityTools': 'الأمان والأدوات',
